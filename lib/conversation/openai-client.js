...
class OpenAIClient {
  constructor() {
    // Mismo criterio que en routes/assistant-intent.js: el SDK espera 10 minutos
    // y reintenta dos veces por defecto. Sin acotarlo, una lentitud de OpenAI se
    // traduce en peticiones colgadas acumulándose y en tres veces el tráfico
    // saliente justo cuando el otro extremo ya no da abasto.
