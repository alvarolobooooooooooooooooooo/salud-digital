...
// ── Lo que esta purga NO toca, y por qué ──
//
// legal_acceptances y legal_audit_events se quedan para siempre. Son la prueba
// de que un profesional aceptó un contrato concreto: borrarla a los noventa
// días dejaría el contrato sin respaldo justo el día que alguien lo discuta.
// Además, la base las protege con triggers append-only, así que un DELETE aquí
// ni siquiera llegaría a ejecutarse (ver lib/legal/schema.js).
//
// Los expedientes clínicos tampoco se tocan desde aquí: su conservación
// depende de plazos legales por jurisdicción y se tramita por el flujo de
// cancelación de cuenta (account_closure_requests), nunca por un temporizador.
